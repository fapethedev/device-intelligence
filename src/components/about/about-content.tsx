        ...
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="grow space-y-6">
            ...
            <div className="flex gap-4">
              <Link href="https://www.linkedin.com/in/abiola-fatigba-a0532a27b/" className="p-3 bg-card rounded-xl hover:text-primary border border-primary/10 transition-colors">
                <FaLinkedin size={24} />
              </Link>
              <Link href="https://twitter.com/fapethedev" className="p-3 bg-card rounded-xl hover:text-primary border border-primary/10 transition-colors">
                <FaTwitter size={24} />
              </Link>
              <Link href="https://facebook.com" className="p-3 bg-card rounded-xl hover:text-primary border border-primary/10 transition-colors">
                <FaFacebook size={24} />
              </Link>
